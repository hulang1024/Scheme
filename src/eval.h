...
#define scm_make_app(operator, operands) SCM_LCONS(operator, operands)

#define scm_quoted_object SCM_CADR
#define scm_make_quotation(o) SCM_LIST2(scm_quote_symbol, o)
...
#define scm_make_if(pred, consequent, alternative) SCM_LIST4(scm_if_symbol, pred, consequent, alternative)
#define scm_make_if1(pred, consequent) SCM_LIST3(scm_if_symbol, pred, consequent)
...
#define scm_make_def(var, val) SCM_LIST3(scm_define_symbol, var, val)
...
#define scm_sequence_exp(seq) (SCM_NULLP(seq) ? seq : SCM_NULLP(SCM_CDR(seq)) ? SCM_CDR(seq) : scm_make_begin(seq))
...
#define scm_make_let(bindings, body) SCM_LIST3(scm_let_symbol, bindings, body)
#define scm_make_named_let(name, bindings, body) SCM_LIST4(scm_let_symbol, name, bindings, body)
